...
impl SantaSleighQueue {
    ...
    pub fn new() -> SantaSleighQueue {
        SantaSleighQueue { records: Mutex::new(VecDeque::new()) }
    }
...
impl ElfTask {
    ...
    pub fn new(name: impl Into<String>, urgency: u32) -> Self {
        Self { name: name.into(), urgency }
    }
}
...
impl ReindeerTask {
    ...
    pub fn new(name: impl Into<String>, weight: u32) -> Self {
        Self { name: name.into(), weight: weight.to_string() }
    }
}
